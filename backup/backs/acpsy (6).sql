...
-- Tiempo de generación: 04-06-2021 a las 19:59:17
...
CREATE TABLE `acpsy_atencion` (
  ...
  `servAtencion` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  ...
  `financiaAtencion` varchar(50) COLLATE utf8_bin DEFAULT NULL,
...
INSERT INTO `acpsy_atencion` (`idAtencion`, `correlativo_Atencion`, `fRegistroAtencion`, `cuentaAtencion`, `historiaAtencion`, `idEstadoPacAtencion`, `fechaPacNacimiento`, `tipdocAtencion`, `nrodocAtencion`, `apPaternoAtencion`, `apMaternoAtencion`, `nombAtencion`, `fIngresoAtencion`, `servAtencion`, `camaAtencion`, `distritoAtencion`, `edadAtencion`, `tipSexoAtencion`, `financiaAtencion`, `idURegAtencion`, `idEstadoAte`) VALUES
(1, 'ACP-2021-00001', '2021-06-04', '1852299', '1274420', 1, '1996-08-31', 'DNI', '77478995', 'CASTRO', 'PALACIOS', 'OLGER IVAN', '2021-05-03', 'MEDICINA', 'CAMA 01', 'CARABAYLLO', '25', 1, 'SIS', 1, 1);
