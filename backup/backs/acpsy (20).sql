...
-- Tiempo de generación: 21-06-2021 a las 20:14:10
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_SEGUIMIENTOS` (IN `_idSeguimiento` INT(11))  SELECT
...
FROM
	...
	WHERE acpsy_seguimiento.idSeguimiento = _idSeguimiento$$
...
--
ALTER TABLE `zacpsy_aud_atenciones`
  MODIFY `idAuditAte` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de la tabla `zacpsy_aud_familiares`
--
ALTER TABLE `zacpsy_aud_familiares`
  MODIFY `idAudiFam` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
