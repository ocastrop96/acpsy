...
--
-- Servidor: localhost
-- Tiempo de generación: 19-07-2021 a las 17:22:17
...
) ENGINE=InnoDB AUTO_INCREMENT=801 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
--
ALTER TABLE `acpsy_atencion`
  MODIFY `idAtencion` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=249;
--
...
--
ALTER TABLE `acpsy_famatencion`
  MODIFY `idFamiliar` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=243;
--
...
--
ALTER TABLE `acpsy_seguimiento`
  MODIFY `idSeguimiento` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=801;
--
...
--
ALTER TABLE `zacpsy_aud_atenciones`
  MODIFY `idAuditAte` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
