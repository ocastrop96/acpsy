...
-- Tiempo de generación: 27-05-2021 a las 09:02:53
...
FROM
	acpsy_profesionales
	INNER JOIN acpsy_condicionprof ON acpsy_profesionales.idCondicion = acpsy_condicionprof.idCondicion
ORDER BY
	acpsy_profesionales.apellidosProfesional ASC$$
