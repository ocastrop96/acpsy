...
-- Tiempo de generación: 11-06-2021 a las 04:50:01
...
(1, 'ACP-2021-00001', '2021-06-04', 'E-101795', '1852299', '1274420', 1, '1996-08-31', 'DNI', '77478995', 'CASTRO', 'PALACIOS', 'OLGER IVAN', '2021-05-03', 'MEDICINA', 'CAMA 01', 'CARABAYLLO', '25', 1, 'SIS', 1, 1),
...
(13, 'ACP-2021-00013', '2021-06-10', '450784', '1900161', '1336928', 3, '1954-03-28', 'DNI', '07171635', 'RODRIGUEZ', 'HURTADO', 'SANTOS', '2021-05-21', 'COVID LEGADO', 'camaguery', 'COMAS', '67', 2, 'PARTICULAR', 1, 1);
...
CREATE TABLE `zacpsy_aud_atenciones` (
  ...
  `cuentaAnterior` text COLLATE utf8_bin NOT NULL,
  `idAtencionAnterior` text COLLATE utf8_bin NOT NULL,
  `cuentaNueva` text COLLATE utf8_bin NOT NULL,
  `idAtencionNueva` text COLLATE utf8_bin NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
