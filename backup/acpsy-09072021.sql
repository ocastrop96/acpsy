...
-- Tiempo de generación: 09-07-2021 a las 17:45:46
...
(1, 125, '2021-07-07', 10, 'MODIFICACIÓN', '1902250', '453091', '1902250', '1908291');
...
--
ALTER TABLE `acpsy_atencion`
  MODIFY `idAtencion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=231;
...
--
ALTER TABLE `acpsy_famatencion`
  MODIFY `idFamiliar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=223;
...
--
ALTER TABLE `acpsy_seguimiento`
  MODIFY `idSeguimiento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=745;
