...
--
-- Servidor: localhost
-- Tiempo de generación: 03-04-2022 a las 20:43:36
...
--
ALTER TABLE `rv_entidades`
  MODIFY `idEntidad` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=129;
...
--
ALTER TABLE `rv_visitas`
  MODIFY `idVisita` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=274;
COMMIT;
