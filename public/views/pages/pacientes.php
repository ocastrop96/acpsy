...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="card">
          ...
          <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <button type="btn" class="ml-2 btn bg-secondary pull-right" id="deshacer-filtro-PAC"><i class="fas fa-undo-alt"></i> Deshacer filtro
                </button>
              </div>
            </div>
          </div>
      ...
      <div class="card-body">
        <table id="" class="table table-bordered table-hover dt-responsive">
          <thead>
            <tr>
